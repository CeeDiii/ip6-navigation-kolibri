...
/**
 * @template T
 * @typedef { Object.<ObservableTypeString, T>} PageControllerConfiguration
 */
 ...
 * @property { () => void } activate    - a lifecycle function that allows a page to do initialization before displaying.<br>This function will be called by a NavigationController on activation of this page.
 * @property { () => void } passivate   - a lifecycle function that allows a page to clean up before removing it from display.<br>This function will be called by a NavigationController on passivation of this page.
 ...
 * @property { (confObj: PageControllerConfiguration) => boolean } setConfiguration - a function that sets the observables of this page for all keys in object to their value.
 ...
 *                                                                    The hash is used for navigation by a {@link NavigationControllerType} and is unique and immutable.
 * @property { (newValue: String) => void } setValue                - a setter function that sets the newValue of the page.
 *                                                                    The value is the name for a page that can be used by both {@link PageProjectorType} and {@link NavigationProjectorType}.
 * @property { () => String } getValue                              - a getter function that returns the value of the page.
 *                                                                    See {@link setValue} for more details.
 ...
 *                                                                    See {@link setActive} for more details.
 * @property { (isVisited: Boolean) => void } setVisited            - a setter function that sets the visited state of the page.
 *                                                                    The visited state declares if a page has been visited before and can be used by both {@link PageProjectorType} and {@link NavigationProjectorType}.
 * @property { () => Boolean } getVisited                           - a getter function that returns the visited state of the page.
 *                                                                    See {@link setVisited} for more details.
 * @property { (isVisible: Boolean) => void } setVisible            - a setter function that sets the isVisible state of the page.
 *                                                                    The visible state declares if a page is visible in the context of the current navigation.
 *                                                                    The visible state will mainly be used by a {@link NavigationProjectorType}.
 *                                                                    Note: a Page can be invisible but still navigational meaning that the user cannot see the page
 *                                                                          in the navigation but can still navigate to it directly with the hash.
 *                                                                          See {@link setNavigational} if you want to make it unreachable.
 * @property { () => Boolean } isVisible                            - a getter function that returns the isVisible state of the page.
 *                                                                    See {@link setVisible} for more details.
 ...
 *                                                                    The parent can be used to hierarchically display a page in a navigation and will mainly be used by a {@link NavigationProjectorType}
 *                                                                    Warning: if you call this method before the parent and this node have been added to the {@link NavigationControllerType}, unexpected behaviour will happen.
 * @property { () => ?PageControllerType } getParent                - a getter function that returns the parent of the page or null.
 *                                                                    See {@link setParent} for more details.
 * @property { (isNavigational: Boolean) => void } setNavigational  - a setter function that sets the navigational state of the page.
 *                                                                    The navigational state declares if a page should be reachable through navigation or if an error should be returned to the user.
 *                                                                    Note: a page can be unnavigational but still visible meaning that a user can see the page
 *                                                                          in the navigation but cannot navigate to it directly with the hash.
 *                                                                          See {@link setVisible} if you want to make it invisible.
 ...
 * @param { [T] } dynamicContentControllers - Dynamic content controllers control a model that can be projected at runtime by a {@link PageProjectorType}.
 *                                            Can be null if none are present.
